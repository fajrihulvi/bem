                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" id="jenis" name="jenis" required>
                                    ...
                                    <option value="<?= $j['id'] ?>" <?= ($j['id'] == $aspirasi->jenis_id)? 'selected':'' ?> ><?= $j['jenis'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" id="ormawa" name="ormawa" required>
                                    ...
                                    <option value="<?= $o['id'] ?>" <?= ($o['id'] == $aspirasi->ormawa_id)? 'selected':'' ?> ><?= $o['nama'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="isi">Isi</label>
                                <textarea class="form-control" id="isi" name="isi" rows="5" required><?= $aspirasi->isi ?></textarea>
                            </div>
