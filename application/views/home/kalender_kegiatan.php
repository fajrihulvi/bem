...
?>
    ...
    <section class="page-title" style="background-image:url(<?= base_url('assets/images/background/7.png') ?>)">
    	<div class="auto-container">
			<div class="content">
				<h1>Kalender <span>kegiatan</span></h1>
    ...
    <section style="padding-top: 50px; padding-bottom: 150px;">
    	<div class="auto-container">
	    	<h4 class="text-center">KALENDER KEGIATAN<br>BULAN <?= strtoupper($arr_bulan[$bulan-1]) ?> TAHUN <?= $tahun ?> </h4>
	    	<br>
	    	<div class="row mb-2">
	    		<div class="col-md-7">
	    		</div>
	    		<div class="col-md-5">
	    			...
	    			<div class="input-group">
						...
						<div class="input-group-prepend">
			    			...
			    			<button type="submit" name="download" class="btn btn-success btn-block"><i class="fa fa-print"></i> Download to Pdf</a>
						</div>
					</div>
					</form>
	    		</div>
